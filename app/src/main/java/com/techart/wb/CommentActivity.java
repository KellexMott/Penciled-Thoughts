...
import com.techart.wb.models.Poem;
import com.techart.wb.models.Story;
import com.techart.wb.utils.NumberUtils;
            ...
            FireBaseUtils.mDatabaseComment.child(postKey).addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    if (!isSent)
                    {
                        ...
                        FireBaseUtils.updateNotifications(postType, postName, "Reader", "commented on ", postKey, comment, ImageUrl.getInstance().getImageUrl());
                        isSent = true;
